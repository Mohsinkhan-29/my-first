...
const ProductsData = [
    {
        ...
        img: Img1,
        title: "Casual Wear",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum optio expedita neque esse possimus illo, labore qui eaque commodi.",
    },
    {
        id: 2,
        img: Img2,
                    ...
                    {ProductsData.map((data) => (
                        <div  data-aos="zoom-in" className='rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]'>
                            ...
                            <div className='h-[100px]'>
                                <img src={data.img} alt="" className='max-w-[140px] block mx-auto transform -translate-y-20 group-hover:scale-105 durantion-300 drop-shadow-md' />
                            </div>
                            {/* details section  */}
                            <div className='p-4 text-center'>
                                ...
                                <p className='text-gray-500 group-hover:text-whie duration-300 text-sm line-clamp-2'>{data.description}</p>
